...
if ($numero_documento) {
    ...
    $sql_consulta = "SELECT * FROM consultas WHERE status_atendimento = 'atendido'";
    $stmt_consulta = $conn->prepare($sql_consulta);
}
...
<body>
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <a href="registro-medico.php" target="_blank" rel="noopener noreferrer" class="novo">Agendar consulta</a>
